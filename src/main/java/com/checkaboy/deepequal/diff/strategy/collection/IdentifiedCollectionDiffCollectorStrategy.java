...
public class IdentifiedCollectionDiffCollectorStrategy<SC extends Collection<SV>, SV, TC extends Collection<TV>, TV>
    ...
    public IdentifiedCollectionDiffCollectorStrategy(Supplier<Collection<IDiffNode>> constructor, IFieldComparator<SV, TV> comparator, IFieldComparator<SV, TV> idComparator) {
