 ...
 */
public class UnorderedCollectionDiffCollectionStrategy<SC extends Collection<SV>, SV, TC extends Collection<TV>, TV>
        extends AbstractCollectionDiffCollectionStrategy<SC, SV, TC, TV>
        implements ICollectionDiffCollectionStrategy<SC, SV, TC, TV> {

    public UnorderedCollectionDiffCollectionStrategy(Supplier<Collection<IDiffNode>> constructor, IFieldComparator<SV, TV> comparator) {
